export const VERY_SMALL_SCREEN_MAX_SIZE = 400;
export const SMALL_SCREEN_MAX_SIZE = 600;
export const MEDIUM_SCREEN_MAX_SIZE = 900;
export const LARGE_SCREEN_MAX_SIZE = 1200;

export const VERY_SMALL_SCREEN_ONLY = `@media only screen and (max-width: ${VERY_SMALL_SCREEN_MAX_SIZE}px)`;
...
export const SMALL_SCREEN_UP = `@media only screen and (min-width: ${VERY_SMALL_SCREEN_MAX_SIZE + 1}px)`;
